...
<form method="POST" action="<?php echo e(isset($task) ? route('tasks.update', $task) : route('tasks.store')); ?>">
    ...
    <input type="datetime-local" name="due_date" class="form-control mb-2"
           value="<?php echo e(old('due_date', $dueDateFormatted)); ?>">
    ...
    <div class="form-check mb-2">
        ...
        <input type="checkbox" class="form-check-input" name="is_completed" value="1"
            <?php echo e(old('is_completed', $task->is_completed ?? false) ? 'checked' : ''); ?>>
        Completed
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leena.baniodeh\task-management-app\resources\views/tasks/edit.blade.php ENDPATH**/ ?>